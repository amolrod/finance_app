    ...
    return (
      <div className="w-full">
        <input
          type={type}
          className={cn(
            'flex h-10 w-full rounded-xl border border-border/60 bg-secondary/50 px-3 py-2 shadow-sm',
            'text-[14px] placeholder:text-muted-foreground/60',
            'transition-colors duration-150',
            'focus:outline-none focus:border-foreground/20 focus:ring-2 focus:ring-ring/15',
